    ...
    <aside className="flex flex-col w-64 h-screen px-4 py-8  bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 fixed top-0 start-0 shadow-lg z-50">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          {show && (
            <div className="flex flex-col rounded-lg  border border-gray-100 bg-gray-100 p-1 shadow">
              <Link
              ...
              <Link
                href="/dashboard/Stock/grab"
                className="flex items-center gap-2 rounded-md px-4 py-2 text-sm 
               text-gray-500 hover:bg-gray-200 ">
                <i className="fa-regular fa-hand h-4 w-4"></i>
                Grab
              </Link>
              <Link
        ...
        <div className="flex items-center px-4 -mx-2">
          {user ? (
            <>
              {" "}
              <Image
                className="mx-2 rounded-full h-9 w-9 object-cover"
          ...
          <Notifications />
          <i
            className="fa-solid fa-right-from-bracket ms-3"
            onClick={Logout}></i>
        </div>
      </div>
    </aside>
